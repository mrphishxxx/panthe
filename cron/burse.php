...
$body = "";
$date = time()-864000;
$tasks = $db->Execute("SELECT * FROM zadaniya WHERE sistema IN ('https://gogetlinks.net/', 'http://getgoodlinks.ru/', 'http://pr.sape.ru/', 'http://rotapost.ru/', 'http://webartex.ru/', 'https://blogun.ru/') AND vipolneno = 1 AND date > '$date'");
$count = $tasks->NumRows();
$yes = $no = "";
//print_r($tasks->NumRows());die();
//31745,31854,31702,31862 
if ($count > 0) {
