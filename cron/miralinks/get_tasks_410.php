...
if($balance < 60){
    ...
    $mira_to_uid = array('revgenich' => '80997889615romer');
    ...
    foreach ($mira_to_uid as $login => $pass) {
        ...
        echo "IP - ".$proxy_data[$proxy_counter]['proxy_host'] . "\r\n";
        try {
    ...
    $file = 'temp_file/miralinks/410-(' . time() . ').txt';
    file_put_contents($file, print_r($result_data, true));
