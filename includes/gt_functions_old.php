<?php
    ...
    function loginTryDone($browser) {
        $browser
            ...
            ->location(MIRALINKS_URL . "ground_articles/allCmArticlesList#/start:0/count:900/sort:6.desc");
    }
    ...
    function loginTryDone1($browser) {
        $browser
            ...
            ->location(MIRALINKS_URL . "ground_articles/allArticlesList#/start:0/count:15/sort:5.desc");
    }
    ...
    function loginTryDone_getPlaceExtended($browser) {
        ...
        for ($i = 0, $n = count($result_data['place']); $i < $n ; $i++) {
            ...
            //echo $article_id . '<br>';
            //if ($result_data['place'][$i]["Article.current_status"] == 'placed') {
