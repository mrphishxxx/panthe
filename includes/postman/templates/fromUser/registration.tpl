...
<div style="font-size: 16px; line-height: normal; padding: 15px 0 0 0; text-shadow: 1px 1px 0 #fff;">
    ...
    <ul>
        <ol>1. <a href="http://iforget.ru/user.php?action=birj">Добавить биржу ссылок</a></ol>
        <ol>2. <a href="http://iforget.ru/user.php?action=sayty">Добавить площадку (сайт)</a></ol>
        <ol>3. <a href="http://iforget.ru/user.php?action=payments">Пополнить баланс</a></ol>
        <ol>4. <a href="http://iforget.ru/user.php?action=lk">Управление личными кабинетом</a></ol>
    </ul>
    <br />
