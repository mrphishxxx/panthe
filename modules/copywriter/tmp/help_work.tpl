...
<p>
    Если текст не был написан в течение суток, задание автоматически снимается с Вас.<br />
    На доработку, так же даются сутки! Если задание не было доработано в течение суток, оно также снимается.
</p>
<p>
