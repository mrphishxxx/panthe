...
<!-- reply form -->
<form action="?module=managers&action=ticket&action2=answer&tid=[tid]" method="post">
    ...
    <div class="action_bar">
        ...
        <input type="submit" onclick="window.location.href = '?module=managers&action=ticket&action2=close&tid=[tid]';
