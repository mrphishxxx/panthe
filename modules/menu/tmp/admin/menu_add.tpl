...
<table>
	<tr>
		...
		<td>
			<input type="text" name="url" id="url" style="width:190px;">
		</td>
	</tr>
	<tr>
		<td>
		...
		<td>
			<input type="text" name="text" id="text" style="width:190px;">
		</td>
	</tr>
	<tr>
		<td>
		...
		<td>
			<input type="checkbox" name="blank" value=1"> Открывать в новом окне
		</td>
	</tr>
	<tr>
		<td>
