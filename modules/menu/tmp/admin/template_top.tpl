...
<table><tr><td><a style="text-decoration:none" href="?module=menu&page=template&action=add"><img style="margin-top:3px;" src="/modules/admins/tmp/admin/img/add.gif"></a></td><td><a style="text-decoration:none" href="?module=menu&page=template&action=add">Добавить</a></td></tr></table>
<br>
<table cellpadding=0 cellspacing=0 border=0 style="border:solid 1px #d8d8ff; border-bottom:none;" >
<tr style="background:#f0f0ff;">
	<td style="width:100px;border-right:solid 1px #d8d8ff; border-bottom:solid 1px #d8d8ff; padding:0 5px;">
		Шаблон
	</td>
