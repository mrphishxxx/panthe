...
<table><tr><td><a style="text-decoration:none" href="?module=menu&action=add"><img style="margin-top:3px;" src="/modules/admins/tmp/admin/img/add.gif"></a></td><td><a style="text-decoration:none" href="?module=menu&action=add">Добавить</a></td></tr></table>
<br>
