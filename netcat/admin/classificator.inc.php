    ...
    if ($countClassif = $db->num_rows) {
        ...
        <form method='post' action='classificator.php'>
            <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                <tr>
                    <td>
                        <table class='nc-table nc--striped nc--small nc--hovered' width='100%'>
                            <tr>
                                <th>ID</th>
...
function OneClassificatorList($ClassificatorID, $SortType, $SortDirection) {
    ...
    <? else : ?>
        ...
        <? if ($admin_cl) : ?>
								<th class='nc-text-center'><div class='icons icon_type_bool' title='<?= CONTROL_CONTENT_CATALOUGE_FUNCS_CATALOGUEFORM_ON ?>'></div></th>
								<th class='nc-text-center'><div class='icons icon_prior' title='<?= CLASSIFICATORS_SORT_PRIORITY_HEADER ?>'></div></th>
