(function(nc, $){
    ...
    fn.save_user_widgets = function(){
        ...
        $.ajax({
            type:     "POST",
            url:      nc.config('netcat_folder') + "admin/dashboard/ajax.php?action=save_user_widgets",
    ...
    fn.reset_user_widgets = function(ln){
        ...
        $.ajax({
            type:     "POST",
            url:      nc.config('netcat_folder') + "admin/dashboard/ajax.php?action=reset_user_widgets",
            dataType: 'json',
            success:  function(){
