...
$navbar->menu->add_btn('#')->icon_large('logo-white')
    ->title('NetCat ' . BEGINHTML_VERSION . ' ' . $VERSION_ID . ' ' . $SYSTEM_NAME)
    ->click('return true');
...
$navbar->menu->help
    ->add_btn('http://www.netcat.ru/developes/docs/', SECTION_INDEX_HELP_SUBMENU_DOC)->icon('docs')->attr('target', '_blank')
    ->add_divider()
