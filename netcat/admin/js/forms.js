        ...
        if (xhr.status == "200") {
            ...
            if (result.error) {
                ...
                if (typeof(result.ui_config) != 'undefined' && typeof(parent.mainView) != 'undefined') {
                    ...
                    parent.mainView.setHeader(newSettings.headerText, newSettings.headerImage);
...
function bindTextareaResizeButtons() {
    $nc('TEXTAREA').each(function(){
        ...
        if (!$this.prev().is('.resize_block')) {
            $nc('<div class="resize_block" style="display: block; margin-right: 15px; margin-top: -10px;"><a class="textarea_shrink" href="#" > &#x25BC; </a> <a class="textarea_grow" href="#"> &#x25B2; </a></div>').insertBefore($this);
        }
        return true;
    });
        ...
        if ($textarea.is('TEXTAREA')) {
            if ($textarea.hasClass('has_codemirror')) {
                ...
                if (cmEditor) {
                    ...
                    height += $this.hasClass('textarea_shrink') ? (-50) : 50;
                    if (height >= 100) {
