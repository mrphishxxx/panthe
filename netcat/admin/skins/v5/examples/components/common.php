...
<?=$nc_core->ui->html('p')->text('Цветной текст (nc-text-red)')->text_red() ?>

<?=$nc_core->ui->html('p')->text('Цветной текст (nc-text-green)')->text_green() ?>

<?=$nc_core->ui->html('p')->text('Цветной текст (nc-text-blue)')->text_blue() ?>

<?=$nc_core->ui->html('p')->text('Цветной текст (nc-text-yellow)')->text_yellow() ?>
