...
class nc_ui_common implements arrayaccess {
    ...
    /**
     * Збрасывает все установленные ранее свойства
     * @return object $this
     */
    ...
    /**
     * Утсановка аттрибутов
     * @param  string $key Название аттрибута
     * @param  string $val Значение аттрибута
     * @return object $this
     */
    ...
    /**
     * Установка аттрибута title=""
     * @param  strint $title Значение тайтла
     * @return object $this
     */
    ...
    /**
     * Установка/сбросс класса-модификатора (nc--*)
     * @param  string  $modificator название модификатора
     * @param  boolean $add         Установка/Сбросс
     ...
     * @param  ыекштп  $class_name Имя класса
    ...
    protected function render_content() {
        ...
        if ($this->href && $this->type && $this->type != 'a') {
            $onclick = isset($this->attr['onclick']) ? "onclick='{$this->attr['onclick']}'" : "";
            $this->remove_attr('onclick');
            $content = "<a href='{$this->href}'{$onclick}>{$content}</a>";
        }
